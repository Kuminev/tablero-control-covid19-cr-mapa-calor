...
df_distritos_positivos <- data.frame("Categorie"=rownames(df_distritos_positivos), df_distritos_positivos)


data <- df_distritos_positivos[,c('distrito', 'positivos')]

class(data$positivos)

p <- data$

fig <- plot_ly(data, labels = ~distrito, values = ~positivos, type = 'pie')
